...
import { ArrowRight, Send, Code as LucideCode, Database, BarChart3 } from 'lucide-react';
  ...
  return (
    <section id="hero" className="py-20 md:py-20 min-h-screen flex items-start">
      <div className="container mx-auto grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        >
          <p className="text-portfolio-primary font-semibold text-lg">Hello, I'm</p>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-transparent text-black dark:text-white bg-clip-text leading-tight">
            Naufal Nizarudeen
          </h1>
          ...
          <p className="text-base sm:text-lg text-portfolio-muted-foreground max-w-xl mx-auto md:mx-0">
            Crafting elegant digital solutions with 3.5+ years of experience. Specializing in full-stack development, data science, and creating exceptional user experiences that drive business value.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start pt-4">
            <Button size="lg" className="bg-portfolio-primary hover:bg-portfolio-secondary text-primary-foreground group whitespace-nowrap" onClick={scrollToProjects}>
              View My Work <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
            </Button>
            <Button size="lg" variant="outline" className="border-portfolio-primary text-portfolio-primary hover:bg-portfolio-primary/10 group whitespace-nowrap" onClick={scrollToContact}>
              Get In Touch <Send className="ml-2 h-5 w-5 group-hover:rotate-12 transition-transform" />
            </Button>
          </div>
          <div className="pt-8">
            <p className="text-portfolio-accent font-medium mb-3 text-center md:text-left">TECHNOLOGIES:</p>
