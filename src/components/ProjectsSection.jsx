...
const featuredProjects = [
  {
    ...
    description: 'A sophisticated machine learning system designed to predict energy consumption patterns for the South West Interconnected System (SWIS), aiding in resource management.',
    tags: ['Python', 'XGBoost', 'Time Series', 'React', 'API Integration'],
  ...
  },
  {
    ...
    description: 'Developed a cutting-edge natural language processing framework leveraging attention mechanisms for intelligent question answering and information retrieval.',
    tags: ['Python', 'PyTorch', 'NLP', 'Transformers', 'BERT'],
  ...
  },
  {
    ...
    description: 'This very portfolio! A modern, responsive website built with React and Tailwind CSS, featuring smooth animations and optimized for user experience.',
...
const projectImagePlaceholders = {
  ...
  portfolioSite: <img  alt="Portfolio Website design preview" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" src="https://images.unsplash.com/photo-1518773553398-650c184e0bb3" src="https://images.unsplash.com/photo-1629752187687-3d3c7ea3a21b" />,
};
...
const ProjectsSection = () => {
  return (
    <section id="projects" className="py-16 md:py-28">
      <SectionTitle title="Featured Projects" subtitle="Showcasing my best work in web development and data science" />
      ...
      <div className="text-center mt-12 md:mt-16">
        <Link to="/projects">
          <Button size="lg" className="bg-portfolio-primary hover:bg-portfolio-secondary text-primary-foreground group whitespace-nowrap">
            View All Projects <ExternalLink className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
          </Button>
        </Link>
      </div>
    </section>
